<div align="center"> <a href="https://@kollorg/molestias-quae-iste.dev/">
    <img
      src="https://github.com/@kollorg/molestias-quae-iste/graphics/raw/HEAD/@kollorg/molestias-quae-iste-landscape-outlined.svg"
      width="650"
      height="auto"
    />
  </a>
...
[![CI](https://github.com/kollorg/molestias-quae-iste/actions/workflows/ci.yml/badge.svg)](https://github.com/kollorg/molestias-quae-iste/actions/workflows/ci.yml)
[![Package Manager
CI](https://github.com/kollorg/molestias-quae-iste/workflows/package-manager-ci/badge.svg?branch=main)](https://github.com/kollorg/molestias-quae-iste/actions/workflows/package-manager-ci.yml)
[![Web
SIte](https://github.com/kollorg/molestias-quae-iste/workflows/website/badge.svg?branch=main)](https://github.com/kollorg/molestias-quae-iste/actions/workflows/website.yml)
...
[![NPM
version](https://img.shields.io/npm/v/@kollorg/molestias-quae-iste.svg?style=flat)](https://www.npmjs.com/package/@kollorg/molestias-quae-iste)
[![NPM
downloads](https://img.shields.io/npm/dm/@kollorg/molestias-quae-iste.svg?style=flat)](https://www.npmjs.com/package/@kollorg/molestias-quae-iste)
[![Security Responsible
Disclosure](https://img.shields.io/badge/Security-Responsible%20Disclosure-yellow.svg)](https://github.com/kollorg/molestias-quae-iste/blob/main/SECURITY.md)
[![Discord](https://img.shields.io/discord/725613461949906985)](https://discord.gg/@kollorg/molestias-quae-iste)
[![Contribute with Gitpod](https://img.shields.io/badge/Contribute%20with-Gitpod-908a85?logo=gitpod&color=blue)](https://gitpod.io/#https://github.com/kollorg/molestias-quae-iste)
![Open Collective backers and sponsors](https://img.shields.io/opencollective/all/@kollorg/molestias-quae-iste)
...
Check out the [`4.x` branch](https://github.com/kollorg/molestias-quae-iste/tree/4.x) for `v4`.
...
### Table of Contents
 ...
 - [Install](#install)
 - [Example](#example)
 - [Fastify v1.x and v2.x](#@kollorg/molestias-quae-iste-v1x-and-v2x)
...
Generate a @kollorg/molestias-quae-iste project with `npm init`:

```sh
npm init @kollorg/molestias-quae-iste
```
...
Create](https://github.com/@kollorg/molestias-quae-iste/create-@kollorg/molestias-quae-iste), which in turn uses the
generate functionality of [Fastify CLI](https://github.com/kollorg/molestias-quae-iste-cli).
...
Install with npm:
```sh
npm i @kollorg/molestias-quae-iste
```
Install with yarn:
```sh
yarn add @kollorg/molestias-quae-iste
```
...
// ESM
import Fastify from '@kollorg/molestias-quae-iste'

const @kollorg/molestias-quae-iste = Fastify({
  logger: true
})
// CommonJs
const @kollorg/molestias-quae-iste = require('@kollorg/molestias-quae-iste')({
  logger: true
})

// Declare a route
@kollorg/molestias-quae-iste.get('/', (request, reply) => {
  reply.send({ hello: 'world' })
})

// Run the server!
@kollorg/molestias-quae-iste.listen({ port: 3000 }, (err, address) => {
  if (err) throw err
...
@kollorg/molestias-quae-iste.get('/', async (request, reply) => {
...
Benchmarks taken using https://github.com/@kollorg/molestias-quae-iste/benchmarks. This is a
...
中文文档[地址](https://github.com/@kollorg/molestias-quae-iste/docs-chinese/blob/HEAD/README.md)
...
- [Community](./docs/Guides/Ecosystem.md#community) - Community supported
  plugins.
- [Live Examples](https://github.com/@kollorg/molestias-quae-iste/example) - Multirepo with a broad
  set of real working examples.
- [Discord](https://discord.gg/D3FZYPy) - Join our discord server and chat with
  the maintainers.

## Support
Please visit [Fastify help](https://github.com/@kollorg/molestias-quae-iste/help) to view prior
...
Fastify has an [Open Collective](https://opencollective.com/@kollorg/molestias-quae-iste)
